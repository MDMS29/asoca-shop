...
class UsuariosModel extends Model
{
    ...
    protected $allowedFields = ['id_rol', 'nombre_p', 'nombre_s', 'apellido_p', 'apellido_s','tipo_user', 'tipo_documento', 'n_documento', 'direccion', 'foto', 'contrasena', 'estado', 'fecha_crea', 'usuario_crea']; /* relacion de campos de la tabla */
